...
class LdapLoggingMiddleware(object):
    ...
    def process_exception(self, request, exception):
        ...
        setup_logger('consumption_info_concise', 'logs/consumption_info_concise.log')
        logger1= logging.getLogger('consumption_info')
        logger2 = logging.getLogger('consumption_info_concise')
